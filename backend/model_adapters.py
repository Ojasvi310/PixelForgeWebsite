...
# # ------------------------------------------------------------------
# # CORE LLM CALLER (GROQ ONLY)
# # ------------------------------------------------------------------

# def call_llm(prompt: str, agent: str = "planner", max_retries: int = 3) -> str:
#     """
...
#     system_msg = "You are an AI agent that outputs ONLY valid JSON or code. No extra text."
